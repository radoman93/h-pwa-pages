(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_service_sold_service_ts"],{
...
/***/ 85298:
/*!*****************************************!*\
  !*** ./src/app/service/sold.service.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SoldService": () => (/* binding */ SoldService)
/* harmony export */ });
...
/* harmony import */ var _store_sold_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store/sold.store */ 28951);
/* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! qs */ 93670);
...
let SoldService = class SoldService {
    constructor(settingsStore, soldStore) {
    ...
    saveSold(data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            try {
                ...
                console.log(data);
                const soldTable = parse__WEBPACK_IMPORTED_MODULE_0__.Object.extend('Sold');
                const sold = new soldTable();
                sold.set(data);
                sold.save();
                console.log("SOLD", sold);
                const t = qs__WEBPACK_IMPORTED_MODULE_5__.stringify(data);
                let config = {
                    method: 'post',
                    url: 'http://94.127.2.67:1337/parse/classes/Sold',
                    headers: {
                        'X-Parse-Application-Id': 'Candy',
                        'X-Parse-Master-Key': 'OdjsSicmsSoifkdsSnfosa',
    ...
    getAllSold() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            try {
                const query = new parse__WEBPACK_IMPORTED_MODULE_0__.Query('Sold');
                const results = yield query.equalTo('user', parse__WEBPACK_IMPORTED_MODULE_0__.User.current()).include('brand').include('model').include('category').descending('createdAt').find();
                const sold = _helper_parse_helper__WEBPACK_IMPORTED_MODULE_2__.ParseHelper.arrayToJSON(results);
                console.log('Got request sold: ', sold);
                for (const el of sold.slice().reverse()) {
                    if (!(yield _helper_pagination_helper__WEBPACK_IMPORTED_MODULE_3__.PaginationHelper.checkExisting(el, this.soldStore.sold))) {
                        this.soldStore.addSoldRequest(el);
                    }
                }
            }
            catch (e) {
                console.log(e);
                return 'Cant get sold';
            }
        });
    }
};
SoldService.ctorParameters = () => [
    { type: _store_settings_store__WEBPACK_IMPORTED_MODULE_1__.SettingsStore },
    { type: _store_sold_store__WEBPACK_IMPORTED_MODULE_4__["default"] }
];
SoldService = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
//# sourceMappingURL=default-src_app_service_sold_service_ts.js.map